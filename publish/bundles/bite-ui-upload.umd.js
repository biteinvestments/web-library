(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('bite-ui/upload', ['exports', '@angular/common/http', '@angular/core', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['bite-ui'] = global['bite-ui'] || {}, global['bite-ui'].upload = {}), global.ng.common.http, global.ng.core, global.ng.common));
    ...
    var UploadComponent = /** @class */ (function () {
        ...
        UploadComponent.prototype.uploadFile = function (file) {
            ...
            this.uploadFileFn(file, null, this.http).subscribe(function (data) {
